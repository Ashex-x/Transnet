...
See [the gateway module documentation](../docs/gateway/gateway.md) for architecture and verification, and [the HTTP contract](../docs/gateway/api.md) for routes and response envelopes.

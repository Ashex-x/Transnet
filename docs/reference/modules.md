...
- [Runtime](runtime.md): configuration, process launch, composition, readiness, and shutdown.
- [Transport](transport.md): UDS server, JSON admission, middleware, and thin API mapping.

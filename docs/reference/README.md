...
See [the core reference](core/README.md) for module ownership and [the core API contract](core/api.md) for request fields, response variants, validation rules, and exact errors.
...
See [the gateway reference](gateway/README.md) for component design and [the gateway API contract](gateway/api/README.md) for the complete route inventory and implementation status of each route.
...
Related: [architecture](../architecture.md), [configuration](../guides/configuration.md), and [development](../guides/development.md).
